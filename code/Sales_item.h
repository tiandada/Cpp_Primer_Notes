 ...
 *      Rights and Permissions Deparment
 *      One Lake Street
...
public:
    ...
    //operations on Slaes_item objects
    std::string isbn() const { return bookNo;}
    double avg_price() const;
//private members as before
private:
    std::string bookNo;      //implicitly initialized to the empy string
...
operator!=(const Sales_item &lhs, const Sales_item &rhs)
{
    return !(lhs == rhs);  //!=define in terms of operator==
}
